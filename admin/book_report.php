                    ...
                    <div class="span9">
                        <div class="container-form">
                            <form method="POST" action="generate_report.php">
                                <label for="from_book_id">From Book ID:</label>
                                <input type="number" id="from_book_id" name="from_book_id" required>
                                <br>
                                <label for="to_book_id">To Book ID:</label>
                                <input type="number" id="to_book_id" name="to_book_id" required>
                                <br>

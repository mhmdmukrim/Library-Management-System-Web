                    ...
                    <div class="span9">
                        <center>
                            ...
                            if (isset($_POST['search'])) {
                                ...
                                $sql = "SELECT record.BookId, record.MembershipNo, book.Title, record.due_date, record.Dues, record.record_id 
                                        FROM record 
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<tr>
                                                ...
                                                <td>" . ($dues ?? 'None') . "</td>
                                                <td>
                                                    <form action='renew_books.php' method='POST'>
                                                        <input type='hidden' name='book_id' value='$bookid'>
                                                        <input type='hidden' name='membership_no' value='$membershipNo'>
                                                        <input type='hidden' name='record_id' value='$record_id'>
                                                        <button type='submit' name='renew' class='btn btn-warning'>Renew</button>
                                                    </form>
                                                </td>
                                              </tr>";
                                    }
